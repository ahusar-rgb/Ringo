...
public class UserRequestDto extends AbstractEntityDto {
    @Pattern(regexp = "^[a-zA-Z'\\s]{3,49}$", message = "Name must be between 3 and 49 characters")
    private String name;
    @Pattern(regexp = "^\\w{3,29}$", message = "Username must be between 3 and 29 characters")
